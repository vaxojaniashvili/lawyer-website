...
export const CONTENT = {
  ka: {
    ...
    cta: {
      call: "დარეკვა",
      consult: "უფასო კონსულტაცია",
      book: "დანიშნეთ შეხვედრა",
    },
    hero: {
    ...
    practice: {
      ...
      subtitle:
        "სისხლის სამართლის ფართო პრაქტიკა — გამოცდილება, რომელიც შედეგს იძლევა.",
      items: [
        {
          icon: "shield",
          title: "დაცვა გამოძიების ეტაპზე",
          text: "პროფესიული დაცვა დაკავების, დაკითხვისა და გამოძიების ყველა სტადიაზე — თქვენი უფლებების სრული დაცვა.",
        },
        {
          icon: "gavel",
          title: "სასამართლო წარმოება",
          text: "ინტერესების წარმომადგენლობა პირველი, სააპელაციო და საკასაციო ინსტანციის სასამართლოებში.",
        },
        {
          icon: "pills",
          title: "ნარკოტიკული დანაშაული",
          text: "ნარკოტიკებთან დაკავშირებული საქმეების დაცვა — რთული კატეგორია, სადაც გამოცდილება გადამწყვეტია.",
        },
        {
          icon: "briefcase",
          title: "ეკონომიკური დანაშაული",
          text: "თეთრსაყელოიანი და ეკონომიკური დანაშაულის საქმეები, სამეწარმეო და საგადასახადო დავები.",
        },
        {
          icon: "fist",
          title: "ძალადობრივი დანაშაული",
          text: "ჯანმრთელობის დაზიანება, ოჯახში ძალადობა და პირის წინააღმდეგ მიმართული სხვა დანაშაულები.",
        },
        {
          icon: "scale",
          title: "ქონებრივი დანაშაული",
          text: "ქურდობა, თაღლითობა, ძარცვა და ყაჩაღობა — მტკიცებულებების ანალიზი და ეფექტური სტრატეგია.",
        },
      ],
    },
    process: {
      ...
      items: [
        {
          ...
          text: "პირველი შეხვედრა, სადაც დეტალურად განვიხილავთ თქვენს საქმეს და შესაძლო გზებს.",
        },
        {
          step: "02",
          title: "საქმის ანალიზი",
          text: "მტკიცებულებების, დოკუმენტაციისა და გარემოებების სიღრმისეული შესწავლა.",
        },
        {
          step: "03",
          title: "დაცვის სტრატეგია",
          text: "ინდივიდუალური სტრატეგიის შემუშავება, რომელიც მაქსიმალურად იცავს თქვენს ინტერესებს.",
        },
        {
          step: "04",
          title: "წარმომადგენლობა",
          text: "თანმიმდევრული და მტკიცე დაცვა გამოძიებასა და სასამართლოში საბოლოო შედეგამდე.",
        },
      ],
    },
    testimonials: {
      ...
      items: [
        {
          name: "გიორგი მ.",
          text: "ურთულეს სიტუაციაში აღმოვჩნდი და მხოლოდ თამთას პროფესიონალიზმის წყალობით დამთავრდა საქმე ჩემს სასარგებლოდ.",
        },
        {
          name: "ნინო კ.",
          text: "მაქსიმალურად ჩართული, ყოველთვის ხელმისაწვდომი და გულწრფელი ადვოკატი. ვგრძნობდი, რომ ჩემი ინტერესები დაცული იყო.",
        },
        {
          name: "დავით შ.",
          text: "საუკეთესო არჩევანი სისხლის სამართლის საქმეში. ცოდნა, გამოცდილება და ადამიანური დამოკიდებულება ერთ ადამიანში.",
        },
      ],
    },
    contact: {
      ...
      subtitle:
        "პირველი კონსულტაცია უფასოა. დაუყოვნებლივ დამიკავშირდით — დრო სისხლის სამართლის საქმეში გადამწყვეტია.",
      phoneLabel: "ტელეფონი",
      emailLabel: "ელ. ფოსტა",
      cityLabel: "ლოკაცია",
      form: {
        ...
        sending: "იგზავნება…",
        success:
          "გმადლობთ! თქვენი შეტყობინება გაიგზავნა. მალე დაგიკავშირდებით.",
        error: "დაფიქსირდა შეცდომა. გთხოვთ, დარეკოთ ან სცადოთ თავიდან.",
        note: "თქვენი ინფორმაცია მკაცრად კონფიდენციალურია.",
      },
      followLabel: "გამომყევით",
    },
    footer: {
  ...
  en: {
    ...
    practice: {
      ...
      subtitle:
        "A broad criminal law practice — experience that delivers results.",
      items: [
        {
          icon: "shield",
          title: "Defense during investigation",
          text: "Professional defense at every stage of arrest, interrogation and investigation — full protection of your rights.",
        },
        {
          icon: "gavel",
          title: "Court representation",
          text: "Representing your interests in courts of first instance, appeals and cassation.",
        },
        {
          icon: "pills",
          title: "Drug-related crimes",
          text: "Defense in drug-related cases — a complex category where experience is decisive.",
        },
        {
          icon: "briefcase",
          title: "Economic crimes",
          text: "White-collar and economic crime cases, business and tax disputes.",
        },
        {
          icon: "fist",
          title: "Violent crimes",
          text: "Bodily harm, domestic violence and other offenses against the person.",
        },
        {
          icon: "scale",
          title: "Property crimes",
          text: "Theft, fraud, robbery — evidence analysis and an effective strategy.",
        },
      ],
    },
    process: {
      ...
      items: [
        {
          ...
          text: "A first meeting where we discuss your case and possible paths in detail.",
        },
        {
          step: "02",
          title: "Case analysis",
          text: "In-depth study of evidence, documentation and circumstances.",
        },
        {
          step: "03",
          title: "Defense strategy",
          text: "Building an individual strategy that protects your interests to the maximum.",
        },
        {
          step: "04",
          title: "Representation",
          text: "Consistent, firm defense in the investigation and in court, to the final result.",
        },
      ],
    },
    testimonials: {
      ...
      items: [
        {
          name: "Giorgi M.",
          text: "I found myself in a very difficult situation, and only thanks to Tamta’s professionalism did the case end in my favor.",
        },
        {
          name: "Nino K.",
          text: "A fully engaged, always available and honest lawyer. I felt my interests were protected at every step.",
        },
        {
          name: "David Sh.",
          text: "The best choice for a criminal case. Knowledge, experience and a human attitude in one person.",
        },
      ],
    },
    contact: {
      ...
      subtitle:
        "The first consultation is free. Contact me immediately — time is critical in a criminal case.",
      phoneLabel: "Phone",
      emailLabel: "Email",
      cityLabel: "Location",
      form: {
        ...
        error: "Something went wrong. Please call or try again.",
